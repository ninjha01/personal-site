...
export const GlobalAlignmentViz = (props: {
  ...
  const middleAlignmentItem = (item: AlignmentItem, sequenceLength: number) => {
    ...
    console.log(marginLeft, sequenceLength);
    return (
      <div
        className={classNames(
          "text-start truncate text-align-start text-xs text-white bg-blue-600 hover:bg-blue-700 rounded-xl my-2 p-1 "
        )}
        style={{
  ...
  return (
    <section>
      <div className="bg-white shadow-md overflow-hidden sm:rounded-lg mt-8 mx-8 p-8">
