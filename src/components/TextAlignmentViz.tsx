  ...
  return (
    <div className="leading-0 items-right mx-4 flex flex-wrap pt-4 text-center font-mono text-sm tracking-widest">
      <div className="flex flex-row flex-wrap">
        <div className={classNames("mr-2 text-right font-thin tracking-tighter text-gray-500")}>
          ...
          <div className={classNames("whitespace-pre-wrap text-blue-700")}>{target_range[0]}:</div>
        </div>
        ...
        <div className="flex flex-row">
          ...
          <div className={classNames("ml-2 text-left font-thin tracking-tighter text-gray-500")}>
            <div className={classNames("whitespace-pre-wrap text-blue-900")}>:{query_range[1]}</div>
            <div className="text-white">{"|"} </div> {/* Should be background color  */}
            <div className={classNames("whitespace-pre-wrap text-blue-700")}>:{target_range[1]}</div>
          </div>
        </div>
      </div>
    </div>
