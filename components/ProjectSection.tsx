    ...
    <section>
      <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-16 lg:order-first">
          <h2 className="-mb-6 border-t border-blue-100 pt-8 text-4xl text-2xl font-bold leading-none tracking-tighter text-blue-100">
            Code
          </h2>
  ...
  return (
    <section className="rounded-2xl border border-zinc-700/40 p-6">
      ...
      >
        ...
        />
        <Button type="submit" variant="primary" className="ml-4 flex-none text-blue-100 ">
          Join
        </Button>
      </form>
    </section>
