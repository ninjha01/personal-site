...
do
    ...
    ##Build the Menu
    cd ./myweb/html/;
    ../../public_html/builders/menu_builder.out ../../public_html/content/essays/writing.md >> "../../${file%md}html";
    cd ../../;
    #Build the bottom
...
##Build the Menu
cd ./myweb/html/;
../../public_html/builders/menu_builder.out ../../public_html/content/essays/writing.md >> ../../myweb/html/index.html;
cd ../../;
##Build the Bottom
